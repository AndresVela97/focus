...
const temporizadorInicio = new Audio('sonidos/play.wav');
const temporizadorPausado = new Audio('sonidos/pause.mp3');
const temporizadorEnCero = new Audio('sonidos/beep.mp3');
